...
export 'package:coffee_shop/core/theme/theme_cubit.dart';

final Map<String, ({ThemeData light, ThemeData dark})> appThemes = {
  "COFFEE_SHOP": (
    light: CoffeeShopX.light(),
    dark: CoffeeShopX.dark(),
  ),
  "MIDNIGHT_BLUE": (
...
extension CoffeeShopX on ThemeData {
  static ThemeData light() {
    return FlexThemeData.light(
      useMaterial3: true,
      colors: const FlexSchemeColor(
        primary: Color(0xFFC67C4E),
        primaryContainer: Color(0xFFEDD6C8 ),
